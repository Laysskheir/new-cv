  ...
  return (
    <div className="relative px-4 sm:px-6 lg:px-8 flex flex-col  py-8 sm:py-12 md:py-16">
      ...
      <motion.div
        ...
        className="flex flex-col mb-6 sm:mb-8 p-2 sm:p-4"
      >
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-1 sm:mb-2 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
          More questions?
        </h1>
        <p className="text-base sm:text-lg text-muted-foreground">We&apos;ve got answers.</p>
      </motion.div>
        ...
        <Accordion type="single" collapsible className="space-y-2 sm:space-y-3">
          ...
          >
            <div className="px-3 sm:px-4 py-2 sm:py-3">
              <AccordionTrigger className="text-sm sm:text-base font-medium hover:no-underline">
                Is this resume builder really free?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground pt-1 sm:pt-2 text-xs sm:text-sm">
